# Scripts 主要仓库
!> 从 [2022-02-12](./start/历史更新?id=_2022-02-12) 版本开始项目不再内置 Scripts 主要脚本仓库，需要自行配置
...
```bash
docker exec -it jd bash -c "git clone -b jd_scripts https://github.com/Aaron-lv/sync.git /jd/scripts"
```

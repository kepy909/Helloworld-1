...
!> __目前无法启用 `ENABLE_SCRIPTS_PROXY` 主要脚本仓库代理变量，[点此查看](./start/%E9%87%8D%E8%A6%81%E9%80%9A%E7%9F%A5?id=_2022-01-19)通知，正在寻找解决办法～__
...
- ### CLI - 命令行
    ...
    -e ENABLE_SCRIPTS_PROXY=false `# 是否为主要脚本仓库启用代理` \
...
- ### Compose - 编排
    ...
    services:
      jd:
        ...
        environment:
          - ENABLE_SCRIPTS_PROXY=false  # 是否为主要脚本仓库启用代理
